...
struct __attribute__((packed)) RawFrame {
    ...
    int16_t  la_x, la_y, la_z;     /* linear accel LACC, mm/s² — 6 bytes
                                      int16 span ±32767 mm/s² ≈ ±3.34 g wire ceiling */
...
struct __attribute__((packed)) CompressedFrame {
    ...
    int16_t  q_delta[4];           /* quaternion delta from previous (Q14 LSBs) */
    int16_t  la_x, la_y, la_z;     /* linear acceleration, mm/s² */
