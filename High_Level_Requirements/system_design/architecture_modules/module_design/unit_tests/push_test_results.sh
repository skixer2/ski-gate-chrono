...
# Hostinger: OpenClaw is in Docker; host path is under /home/node/.openclaw/ipcra_ws
REMOTE_HOST="${SGC_RESULTS_HOST:-72.60.88.60}"
REMOTE_PORT="${SGC_RESULTS_PORT:-22}"
REMOTE_USER="${SGC_RESULTS_USER:-root}"
REMOTE_PATH="${SGC_RESULTS_PATH:-/home/node/.openclaw/ipcra_ws/1_Projects/ski_gate_chrono/High_Level_Requirements/system_design/architecture_modules/module_design/unit_tests/tmp_test_results}"
